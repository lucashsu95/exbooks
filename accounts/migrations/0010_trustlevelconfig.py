    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demotion_protection_weeks', models.PositiveSmallIntegerField(default=26, help_text='達到此等級後的保護期限，期間內若積分不足也不會降級', verbose_name='降級保護週數')),
                ('badge_icon', models.CharField(blank=True, help_text='CSS class 或圖片路徑', max_length=100, verbose_name='徽章圖標')),
            ],
            options={
                'verbose_name': '信用等級配置',
